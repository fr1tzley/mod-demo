...
public class SaveFormat {
   ...
   private static Pair<DimensionGeneratorSettings, Lifecycle> func_237259_a_(Dynamic<?> p_237259_0_, DataFixer p_237259_1_, int p_237259_2_) {
      ...
      Dynamic<?> dynamic1 = p_237259_1_.update(TypeReferences.field_233375_y_, dynamic, p_237259_2_, SharedConstants.getVersion().getWorldVersion());
      DataResult<DimensionGeneratorSettings> dataresult = DimensionGeneratorSettings.field_236201_a_.parse(dynamic1);
      return Pair.of(dataresult.resultOrPartial(Util.func_240982_a_("WorldGenSettings: ", field_215785_a::error)).orElseGet(DimensionGeneratorSettings::func_236210_a_), dataresult.lifecycle());
   }
   ...
   private static DatapackCodec func_237272_b_(File p_237272_0_, DataFixer p_237272_1_) {
      try {
         CompoundNBT compoundnbt = CompressedStreamTools.readCompressed(new FileInputStream(p_237272_0_));
   ...
   private static BiFunction<File, DataFixer, ServerWorldInfo> func_237270_b_(DynamicOps<INBT> p_237270_0_, DatapackCodec p_237270_1_) {
       return func_237270_b_(p_237270_0_, p_237270_1_, null);
   }
   ...
   private static BiFunction<File, DataFixer, ServerWorldInfo> func_237270_b_(DynamicOps<INBT> p_237270_0_, DatapackCodec p_237270_1_, @Nullable LevelSave levelSave) {
      return (p_237261_2_, p_237261_3_) -> {
         try {
            CompoundNBT compoundnbt = CompressedStreamTools.readCompressed(new FileInputStream(p_237261_2_));
            CompoundNBT compoundnbt1 = compoundnbt.getCompound("Data");
            CompoundNBT compoundnbt2 = compoundnbt1.contains("Player", 10) ? compoundnbt1.getCompound("Player") : null;
            compoundnbt1.remove("Player");
            int i = compoundnbt1.contains("DataVersion", 99) ? compoundnbt1.getInt("DataVersion") : -1;
            Dynamic<INBT> dynamic = p_237261_3_.update(DefaultTypeReferences.LEVEL.func_219816_a(), new Dynamic<>(p_237270_0_, compoundnbt1), i, SharedConstants.getVersion().getWorldVersion());
            ...
            ServerWorldInfo info = ServerWorldInfo.func_237369_a_(dynamic, p_237261_3_, i, compoundnbt2, worldsettings, versiondata, pair.getFirst(), pair.getSecond());
            if (levelSave != null)
   ...
   private BiFunction<File, DataFixer, WorldSummary> func_237267_a_(File p_237267_1_, boolean p_237267_2_) {
      return (p_237268_3_, p_237268_4_) -> {
         try {
            CompoundNBT compoundnbt = CompressedStreamTools.readCompressed(new FileInputStream(p_237268_3_));
            CompoundNBT compoundnbt1 = compoundnbt.getCompound("Data");
            compoundnbt1.remove("Player");
            int i = compoundnbt1.contains("DataVersion", 99) ? compoundnbt1.getInt("DataVersion") : -1;
            Dynamic<INBT> dynamic = p_237268_4_.update(DefaultTypeReferences.LEVEL.func_219816_a(), new Dynamic<>(NBTDynamicOps.INSTANCE, compoundnbt1), i, SharedConstants.getVersion().getWorldVersion());
            VersionData versiondata = VersionData.func_237324_a_(dynamic);
            ...
            field_215785_a.error("Exception reading {}", p_237268_3_, exception);
            return null;
         }
      };
   }
   ...
   public class LevelSave implements AutoCloseable {
      ...
      public IServerConfiguration func_237284_a_(DynamicOps<INBT> p_237284_1_, DatapackCodec p_237284_2_) {
         this.func_237301_i_();
         return SaveFormat.this.func_237266_a_(this.field_237279_c_.toFile(), SaveFormat.func_237270_b_(p_237284_1_, p_237284_2_, this));
      }
      ...
      public void func_237288_a_(IDynamicRegistries p_237288_1_, IServerConfiguration p_237288_2_, @Nullable CompoundNBT p_237288_3_) {
         ...
         try {
            ...
            CompressedStreamTools.writeCompressed(compoundnbt1, new FileOutputStream(file2));
